...
angular.module("insight.status").controller("StatusController",function($scope,$routeParams,$location,Global,Status,Sync,getSocket, Supply){$scope.global=Global, var totalCoins = 0, $scope.startSupply = function(){
		Supply.get({},
		 function(data){
